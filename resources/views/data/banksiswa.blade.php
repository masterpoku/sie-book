                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <img 
                                        src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ urlencode(url('/siswa/qrcode?siswa=' . $siswa->unique)) }}" 
                                        alt="{{ urlencode(url('/siswa/qrcode?siswa=' . $siswa->unique)) }}"
                                    >
                                </td>
