            ...
            <tbody>
                @foreach ($siswa as $data)
                    <tr>
                        ...
                        <td>
                        <!-- Tombol QR -->
                        <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#qrcodeModal{{ $data->id }}">
                            Lihat QR
                        </button>

                        <!-- Modal QR -->
                        <div class="modal fade" id="qrcodeModal{{ $data->id }}" tabindex="-1" aria-labelledby="qrcodeModalLabel{{ $data->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-sm modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="qrcodeModalLabel{{ $data->id }}">QR Siswa:</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                    </div>
                                    <div class="modal-body text-center">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data={{ urlencode(url('/siswa/qrcode?siswa=' . $data->unique)) }}" alt="QR {{ $data->unique }}" class="img-fluid mb-2">
                                        <div><strong>{{ strtoupper($data->nama) }}</strong></div>
                                    </div>
